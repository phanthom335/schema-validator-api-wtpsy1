    """
    Schema Validator Api Wtpsy1
    ===========================
    Developer-ready web service for routeing requests with built-in validation.
    ...
    APP_NAME    = "Schema Validator Api Wtpsy1"
    APP_VERSION = "1.0.0"
...
return app
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="Developer-ready web service for routeing requests with built-in validation.")
